...
class AppLauncher {
  constructor() {
    this.apps = {}
    this.windowManager = windowManager // Référence directe à la variable globale
    this.storage = storage // Référence directe à la variable globale
  ...
  launchAbout() {
    ...
    this.windowManager.createWindow("about", "À propos de " + CONFIG.user.name, contentGenerator)
  }
  ...
  launchProjects() {
    ...
    this.windowManager.createWindow("projects", "Mes projets", contentGenerator)
  }
  ...
  launchCV() {
    ...
    this.windowManager.createWindow("cv", "Mon CV", contentGenerator)
  }
  ...
  launchCalculator() {
    ...
    this.windowManager.createWindow("calculator", "Calculatrice", contentGenerator)
  }
  ...
  launchChrome() {
    ...
    this.windowManager.createWindow("chrome", "Google Chrome", contentGenerator)
  }
