...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/vet">Accueil</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/vet/reports">Gérer Rapports</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/vet/habitats">Habitats</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/vet/animals">Animaux</a>
            </li>
            <li class="nav-item">
