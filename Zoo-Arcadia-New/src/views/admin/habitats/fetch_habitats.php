    ...
    <div class="col-md-6">
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                ...
                <a href="/Portfolio/Zoo-Arcadia-New/admin/habitats?action=delete&id=<?php echo $habitat['id']; ?>&csrf_token=<?php echo $_SESSION['csrf_token']; ?>" class="btn btn-danger btn-delete">Supprimer</a>
            </div>
        </div>
    </div>
<?php endforeach; ?>
