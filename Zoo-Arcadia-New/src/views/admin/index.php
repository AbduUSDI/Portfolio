...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    <a class="navbar-brand" href="/Portfolio/Zoo-Arcadia-New/home"><img src="/Zoo-Arcadia-New/assets/favicon.ico" width="32px" height="32px"> Zoo Arcadia</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin">Accueil</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/users">Gérer Utilisateurs</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/services">Gérer Services</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/habitats">Gérer Habitats</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/animals">Gérer Animaux</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/reports">Gérer Rapports Vétérinaires</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Portfolio/Zoo-Arcadia-New/admin/horaires">Gérer Horaires</a>
            </li>
            <li class="nav-item">
    ...
    <div class="containerr p-4">
        <div class="row">
            <div class="col-md-4">
                ...
                <ul class="navbar-nav">
                <li class="nav-item">
                        <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/contact">
                            <i class="fas fa-envelope mr-2"></i> Nous contacter
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/home#openhours">
                            <i class="fas fa-clock mr-2"></i> Nos horaires
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/aproposdenous">
                            <i class="fas fa-info-circle mr-2"></i> A propos de nous
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/mentions-legales">
                            <i class="fas fa-file-alt mr-2"></i> Mentions légales
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/politique-de-confidentialite">
