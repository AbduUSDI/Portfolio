    ...
    if ($email && $password) {
        ...
        if ($userData && password_verify($password, $userData['password'])) {
            ...
            if ($userData['role_id'] == 1) {
                header('Location: /Portfolio/Zoo-Arcadia-New/admin');
            } elseif ($userData['role_id'] == 2) {
                header('Location: /Portfolio/Zoo-Arcadia-New/employee');
            } elseif ($userData['role_id'] == 3) {
                header('Location: /Portfolio/Zoo-Arcadia-New/vet');
            } else {
...
<div class="container custom" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    ...
    <form action="/Portfolio/Zoo-Arcadia-New/login" method="POST">
