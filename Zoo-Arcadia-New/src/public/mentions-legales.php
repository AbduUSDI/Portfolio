            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/mentions-legales">Mentions légales</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-secondary" href="/Portfolio/Zoo-Arcadia-New/politique-de-confidentialite">Politique de confidentialité</a>
                        </li>
                    </ul>
                </div>
