...
<div class="containerr my-5" style="background: linear-gradient(to right, #ffffff, #ccedb6); border-radius: 15px; padding: 20px;">
    <div class="row align-items-center mb-5">
        <div class="col-md-5">
            <img src="/Zoo-Arcadia-New/assets/image/Welcomearcadia.webp" class="img-fluid rounded shadow mb-4" alt="Image 1">
        </div>
        <div class="col-md-7">
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
        <div class="col-md-5">
            <img src="/Zoo-Arcadia-New/assets/image/habitatindex.webp" class="img-fluid rounded shadow mb-4" alt="Image 2">
        </div>
        <div class="col-md-7">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-5">
            <img src="/Zoo-Arcadia-New/assets/image/respect.webp" class="img-fluid rounded shadow mb-4" alt="Image 3">
        </div>
        <div class="col-md-7">
            ...
            <?php foreach ($habitats as $habitat): ?>
                <div class="col-md-6">
                    <div class="card mb-4 shadow-sm">
                        <img class="card-img-top" src="/Zoo-Arcadia-New/assets/uploads/<?php echo htmlspecialchars($habitat['image']); ?>" alt="<?php echo htmlspecialchars($habitat['name']); ?>">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($habitat['name']); ?></h5>
                            <p class="card-text"><?php echo $habitat['description']; ?></p>
                            <a href="/Portfolio/Zoo-Arcadia-New/habitat/<?php echo $habitat['id']; ?>" class="btn btn-success btn-block">Voir les habitants</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
...
<div class="container my-5">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($hour['open_time'] === '00:00:00' && $hour['close_time'] === '00:00:00') {
                                ...
                                echo htmlspecialchars(substr($hour['open_time'], 0, 5)) . ' - ' . htmlspecialchars(substr($hour['close_time'], 0, 5));
                            }
                            ?>
                        </td>
                        <td>
                            ...
                            if ($hour['open_time'] === '00:00:00' && $hour['close_time'] === '00:00:00') {
                                ...
                                echo '<span class="badge badge-success">Ouvert</span>';
                            }
                            ?>
                        </td>
                    </tr>
    ...
    <div>
        ...
        <div id="avis" class="col-md-8 mx-auto">
            <form action="/Portfolio/Zoo-Arcadia-New/submit_review" method="POST" class="mt-5">
