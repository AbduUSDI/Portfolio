...
if (isset($_SESSION['LAST_ACTIVITY']) && (time() - $_SESSION['LAST_ACTIVITY'] > $sessionLifetime)) {
    session_unset();  
    session_destroy(); 
    header('Location: /Portofolio/Zoo-Arcadia-New/login');
    exit;
}
...
if (!$animal_id) {
    header("Location: /Portofolio/Zoo-Arcadia-New/animals");
    exit;
}
...
<div class="container mt-5" style="background: linear-gradient(to right, #ffffff, #ccedb6);">
    ...
    <form action="/Portfolio/Zoo-Arcadia-New/animal/<?php echo $animal_id; ?>" method="POST">
