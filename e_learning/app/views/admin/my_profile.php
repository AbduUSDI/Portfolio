                        ...
                        <?php else: ?>
                            <?php foreach ($friends as $friend): ?>
                                <li class="list-group-item">
                                    ...
                                    <form action="/Portfolio/e_learning/admin/profile" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet ami ?');">
                            ...
                            <?php foreach ($userThreads as $thread): ?>
                                <li class="list-group-item">
                                    ...
                                    <div class="collapse" id="editThreadForm<?php echo $thread['id']; ?>">
                                        <form action="/Portfolio/e_learning/admin/profile" method="POST">
                        ...
                        <ul class="list-group">
                            <?php foreach ($friendRequests as $request): ?>
                                <li class="list-group-item">
                                    ...
                                    <form action="/Portfolio/e_learning/admin/profile" method="POST" class="d-inline">
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/Portfolio/e_learning/admin/profile" method="POST" enctype="multipart/form-data">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    friendProfileLinks.forEach(function(link) {
        link.addEventListener('click', function(event) {
            ...
            fetch('/Portfolio/e_learning/admin/get_profile/' + userId)
